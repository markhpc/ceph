 ...
 *
 */
#ifndef CEPH_OSD_PETSTORE_VECTOROBJECT_H
#define CEPH_OSD_PETSTORE_VECTOROBJECT_H

#include <boost/intrusive_ptr.hpp>

#include "PetObject.h"

struct VectorObject : public PetObject {
  ceph::spinlock mutex;
  std::vector<char> data;

  VectorObject(CephContext *cct, const ghobject_t& oid) : PetObject(cct, oid) {}
  ...
  int clone(PetObject *o, uint64_t srcoff, uint64_t len,

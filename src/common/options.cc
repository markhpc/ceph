...
std::vector<Option> get_global_options() {
  return std::vector<Option>({
    ...
    Option("osd_mem_target", Option::TYPE_UINT, Option::LEVEL_BASIC)
    .set_default(4_G)
    .add_see_also("bluestore_cache_autotune")
    .set_description("When cache autotuning is enabled, Try to keep this many bytes mapped in memory."),

    Option("osd_mem_base", Option::TYPE_UINT, Option::LEVEL_DEV)
    .set_default(768_M)
    .add_see_also("bluestore_cache_autotune")
    .set_description("When cache autotuning is enabled, Estimate the minimum amount of memory in bytes the OSD will need."),

    Option("osd_mem_expected_fragmentation", Option::TYPE_FLOAT, Option::LEVEL_DEV)
    .set_default(0.15)
    .add_see_also("bluestore_cache_autotune")
    .set_description("When cache autotuning is enabled, Estimate the percent of memory fragmentation."),

    Option("osd_mem_cache_min", Option::TYPE_UINT, Option::LEVEL_DEV)
    .set_default(128_M)
    .add_see_also("bluestore_cache_autotune")
    .set_description("When cache autotuning is enabled, Set the minmum amount of memory provide for caches."),
